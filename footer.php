		...
		<div class="container">
			<footer class="row">
				<nav id="footer-column-1" class="col-md-6">
					<ul id="nav-social">
						<li><a href="http://twitter.com/eponymous4"><img src="<?php echo TemplateTags::get_cdn_uri(); ?>/web/images/icons/twitter.png" alt="[Twitter]" title="[Twitter]" /></a></li>
						<li><a href="http://www.facebook.com/eponymous4"><img src="<?php echo TemplateTags::get_cdn_uri(); ?>/web/images/icons/facebook.png" alt="[Facebook]" title="[Facebook]" /></a></li>
